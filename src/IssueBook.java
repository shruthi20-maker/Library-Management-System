...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, 200, -1));

        jTextField2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, 200, -1));
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 270, 200, -1));
        getContentPane().add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 360, 200, -1));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/issuebook-2.jpg"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 850, 610));
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                if(rsl.next())
                {
                    ...
                    JOptionPane.showConfirmDialog(null,"Issued successfully");
                    setVisible(false);
                    new IssueBook().setVisible(true);
                }
                else 
                {
                    JOptionPane.showConfirmDialog(null,"Incorrrect studentID");
                }
  ...
  /*  private static class SimpleDataFormat extends SimpleDateFormat {

        public SimpleDataFormat(String ddMMyyyy) {
        }
    }*/
}